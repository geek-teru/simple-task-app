...
var UserTestData = []*ent.User{
	&ent.User{
		...
		//D: 1, Name: "alice", Email: "alice@example.com", Password: "$2a$10$IUjSMm7z8i6QaF5BfOc7wOKRkQqdDZ4TkmzutyAOe42vwteaKiqsO",
	},
	&ent.User{
		// 未登録
...
var UserReqTestData = []service.UserRequest{
	service.UserRequest{
		// 登録済み
		Name: "alice", Email: "alice@example.com", Password: "$2a$10$IUjSMm7z8i6QaF5BfOc7wOKRkQqdDZ4TkmzutyAOe42vwteaKiqsO",
	},
	service.UserRequest{
		// 未登録
		Name: "bob", Email: "bob@example.com", Password: "$2a$10$ExzssGX4xS4joeZx7aO9SOpWXLBzhAQxjMBleRxf8ziC961FkJ7qq",
	},
}
